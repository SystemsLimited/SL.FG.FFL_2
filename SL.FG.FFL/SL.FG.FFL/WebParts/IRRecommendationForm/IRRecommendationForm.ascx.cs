...
namespace SL.FG.FFL.WebParts.IRRecommendationForm
{
    ...
    public partial class IRRecommendationForm : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    {
                        this.hdnRecommendationId.Value = Page.Request.QueryString["IR01DI_ID"];
                        this.hdnParamName.Value = "IR01DI_ID";
                        this.hdnParentListName.Value = "IR01DI";
                    ...
                    {
                        this.hdnRecommendationId.Value = Page.Request.QueryString["IR03DI_ID"];
                        this.hdnParamName.Value = "IR03DI_ID";
                        this.hdnParentListName.Value = "IR03DI";
                        this.hdnRecommendationListName.Value = "IIRRecommendationOnJob";
                        this.hdnFRIDName.Value = "FlashReportID";
                    }
                    else if (!String.IsNullOrEmpty(Page.Request.QueryString["IR05DI_ID"]))
                    {
                        this.hdnRecommendationId.Value = Page.Request.QueryString["IR05DI_ID"];
                        this.hdnParamName.Value = "IR05DI_ID";
                        this.hdnParentListName.Value = "IR-5-Off";
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private ListItem FillApprovalAuthority(SPWeb oSPWeb, string departmentName)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->FillApprovalAuthority)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return hodLI;
        }
        private bool InitializeRecommendationControls(int recommendationId, string recommendationList, string parentList)
        {
                        ...
                        if (!String.IsNullOrEmpty(recommendationList) && !String.IsNullOrEmpty(parentList))
                        {
                            ...
                            if (spListR != null)
                            {
                                ...
                                if (spListItemR != null)
                                {
                                    ...
                                    if (!String.IsNullOrEmpty(Convert.ToString(spListItemR["IIRDescription"])))
                                    {
                                        this.description_ta.Value = Convert.ToString(spListItemR["IIRDescription"]);
                                    }
                                        ...
                                        if (spList != null)
                                        {
                                            ...
                                            if (spListItem != null)
                                            {
                                                if (!String.IsNullOrEmpty(this.hdnFRIDName.Value) && !String.IsNullOrEmpty(Convert.ToString(spListItem[this.hdnFRIDName.Value])))
                                                {
                                                    ...
                                                    if (recommendationList.Equals("IIRRecommendationOnJob", StringComparison.OrdinalIgnoreCase))
                                                    {
                                                        flashReportId = Convert.ToInt32(Convert.ToString(spListItem[this.hdnFRIDName.Value]));
                                                        spListNameFR = "FlashReport";
                                                    }
                                                    else
                                                    {
                                                        flashReportId = Convert.ToInt32(Convert.ToString(spListItem[this.hdnFRIDName.Value]));
                                                        spListNameFR = "FlashReportOff";
                                                    }
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(Recommendation->InitializeRecommendationControls)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private bool SaveRecommendation(string currentOperation, string listName, string paramName)
        {
                    ...
                    using (SPWeb oSPWeb = oSPsite.OpenWeb())
                    {
                        if (!String.IsNullOrEmpty(this.hdnRecommendationId.Value))
                        {
                            ...
                            if (spListItem != null)
                            {
                                ...
                                {
                                    message_div.InnerHtml = "Approving Authority not available!!!  Please contact the administrator at email address - FFL.HSE@fatima-group.com.";
                                    return false;
                                }
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(Recommendation->SaveRecommendation)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->btnSend_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->btnApprove_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnReject_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->btnReject_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnWaiver_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.hdnRecommendationListName.Value.Equals("IIRRecommendationOnJob"))
                {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->btnWaiver_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->btnCancel_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(RecommendationForm->btnSave_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
