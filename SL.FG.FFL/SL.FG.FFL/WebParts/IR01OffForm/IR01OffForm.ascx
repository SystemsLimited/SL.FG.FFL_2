...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IR01OffForm.ascx.cs" Inherits="SL.FG.FFL.WebParts.IR01OffForm.IR01OffForm" %>
                            ...
                            <div class="form-group row">
                                 <div class="col-lg-6">
                                    <div class="form-inline">
                                        <label>Is investigation team required? &nbsp;&nbsp;</label>
                                ...
                                <div class="col-lg-6">
                                    <div id="" style="display:none">
                                        <div class="form-inline">
                                            <label>Is detailed report required?  &nbsp;&nbsp;</label>
...
<script src="/_layouts/15/SL.FG.FFL/Scripts/Validation/IR01Off.js"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("[id$=IncidentCategory_ddl]").each(function () {
            ...
            if ($("[id$=IncidentCategory_ddl] option:selected").val() != "" && $("[id$=IncidentCategory_ddl] option:selected").val() != "undefined") {
