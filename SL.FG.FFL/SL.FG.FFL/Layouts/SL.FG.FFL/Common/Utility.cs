...
namespace SL.FG.FFL.Layouts.SL.FG.FFL.Common
{
    public class Utility
    {
        ...
        public static List<SPUser> GetGroupMembers(string groupName)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(Utility->GetGroupMembers)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return Users;
        }
    }
