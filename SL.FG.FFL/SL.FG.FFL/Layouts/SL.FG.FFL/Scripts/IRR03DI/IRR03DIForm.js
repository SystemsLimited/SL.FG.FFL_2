...
$(document).ready(function () {
    ...
    $('[id$=actualOrPotentialInquiry_ddl]').on('change', function () {
        $("[id$=actualOrPotentialInquiry_ddl]").each(function () {
            $("[id$=hdnActualOrPotentialInquiry]").val($(this).val());
        });
    });

    $('[id$=processSafetyIncidents_ddl]').on('change', function () {
        $("[id$=processSafetyIncidents_ddl]").each(function () {
            $("[id$=hdnProcessSafetyIncidents]").val($(this).val());
        });
    });

    $('[id$=miscellaneousIncidents_ddl]').on('change', function () {
        $("[id$=miscellaneousIncidents_ddl]").each(function () {
            $("[id$=hdnMiscellaneousIncidents]").val($(this).val());
        });
    });
    ...
    $('[id$=riskBasedElements_ddl]').on('change', function () {
        $("[id$=riskBasedElements_ddl]").each(function () {
            $("[id$=hdnRiskBasedElements]").val($(this).val());
        });
    });

    $('[id$=culturalBasedElements_ddl]').on('change', function () {
        $("[id$=culturalBasedElements_ddl]").each(function () {
            $("[id$=hdnCulturalBasedElements]").val($(this).val());
        });
    });
